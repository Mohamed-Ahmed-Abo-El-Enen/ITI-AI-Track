public class Pyramid {
    ...
    public void updatePyramid(Pyramid pyramid) {
        this.Pharaoh = pyramid.getPharaoh();
        this.modernName = pyramid.getModernName();
        this.Site = pyramid.getSite();
        this.Height = pyramid.getHeight();
    }

    public void PrintPyramid()
    {
        System.out.println("Pharaoh : "+this.Pharaoh);
        System.out.println("Modern Name : "+this.modernName);
